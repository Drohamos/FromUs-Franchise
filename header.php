...
<header>
	<div id="headerContainer">
		<nav id="mainMenu" class="pure-menu pure-menu-horizontal">
			<a href="index.php" id="logo" class="pure-menu-heading"><img src="images/logo.png" alt=""></a>
			<ul class="pure-menu-list">
				<li class="pure-menu-item"><a href="#" class="pure-menu-link">Qui sommes-nous ?</a></li>
				<li class="pure-menu-item"><a href="devenir-franchise.php" class="pure-menu-link">Devenir franchisé</a></li>
