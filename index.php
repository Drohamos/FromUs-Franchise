...
<article class="iconsWithDesc">
	<header><h2 class="xxlarge titleWithUnderline">Les valeurs de From-US.com</h2></header>
	<ul class="pure-g">
		<li class="pure-u-1 pure-u-md-1-2" style="background-image: url(images/icon_aventure.png)">
			<h3 class="red large">Une aventure 100% US</h3>
		...
		<li class="pure-u-1 pure-u-md-1-2" style="background-image: url(images/icon_service-client.png)">
			<h3 class="red large">Un service proche de ses clients</h3>
...
<article class="fullWidth">
	<img class="fullWidth" src="images/banniere_devenez-franchise.jpg" />
</article>

<article id="joinUs">
	<form class="pure-form">
		<header class="red large">VOUS SOUHAITEZ ÊTRE RAPPELÉ(E) (DU LUNDI AU VENDREDI, ENTRE 9H00 ET 17H00 HEURE LOCALE)</header>
		<div class="pure-g">
